...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002995624443').split()]
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002627549729'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1002982934807')
